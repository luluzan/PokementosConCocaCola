<template>
    <v-card class="mx-auto" max-width="220" :style="{ backgroundColor: typeColors[pokemon.type] }" cover>
      <v-img class="align-end text-black" :src="pokemon.imageUrl" :style="{ backgroundColor: typeColors[pokemon.type] }" cover contain>
     </v-img>
        ...
        <div class="text-center">
          ...
          <v-overlay v-model="overlay" class="align-center justify-center">
            <v-card class="mx-auto" width="70vw">
              <v-img class="align-end text-black" :src="pokemon.imageUrl" :style="{ backgroundColor: typeColors[pokemon.type] }" fit>
